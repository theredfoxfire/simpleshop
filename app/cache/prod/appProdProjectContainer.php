...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/wedus/wedusweb/simpleshop/app/cache/prod/annotations', false);
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'simpleshop', 'user' => 'root', 'password' => '13264656#vL', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'ss.ss.admin.category', 1 => 'ss.ss.admin.product'));
        $instance->setAdminGroups(array('SimpleShop' => array('label' => 'SimpleShop', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'ss.ss.admin.category', 1 => 'ss.ss.admin.product'))));
        $instance->setAdminClasses(array('Ss\\SsBundle\\Entity\\Category' => array(0 => 'ss.ss.admin.category'), 'Ss\\SsBundle\\Entity\\Product' => array(0 => 'ss.ss.admin.product')));
        return $instance;
    }
    protected function getSonata_Admin_Route_CacheService()
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('/home/wedus/wedusweb/simpleshop/app/cache/prod/sonata/admin', false);
    }
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'ss.ss.admin.category', 1 => 'ss.ss.admin.product'), $this);
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/wedus/wedusweb/simpleshop/app/cache/prod/translations', 'debug' => false));
        ...
        $instance->addResource('xliff', '/home/wedus/wedusweb/simpleshop/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ar.xliff', 'ar', 'SonataAdminBundle');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/wedus/wedusweb/simpleshop/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/wedus/wedusweb/simpleshop/app/../web', false);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/wedus/wedusweb/simpleshop/app/cache/prod/swiftmailer/spool/default',
