 ...
 */
class Pesanan extends \Ss\SsBundle\Entity\Pesanan implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ss\\SsBundle\\Entity\\Pesanan' . "\0" . 'id', '' . "\0" . 'Ss\\SsBundle\\Entity\\Pesanan' . "\0" . 'qty', '' . "\0" . 'Ss\\SsBundle\\Entity\\Pesanan' . "\0" . 'token', '' . "\0" . 'Ss\\SsBundle\\Entity\\Pesanan' . "\0" . 'is_payyed', '' . "\0" . 'Ss\\SsBundle\\Entity\\Pesanan' . "\0" . 'created_at', '' . "\0" . 'Ss\\SsBundle\\Entity\\Pesanan' . "\0" . 'updated_at', '' . "\0" . 'Ss\\SsBundle\\Entity\\Pesanan' . "\0" . 'products', '' . "\0" . 'Ss\\SsBundle\\Entity\\Pesanan' . "\0" . 'orderers');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pesanan $proxy) {
    ...
    public function setIsPayyed($isPayyed)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsPayyed', array($isPayyed));

        return parent::setIsPayyed($isPayyed);
    }
    ...
    public function getIsPayyed()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsPayyed', array());

        return parent::getIsPayyed();
    }
    ...
    public function setOrderers(\Ss\SsBundle\Entity\Orderer $orderers = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrderers', array($orderers));

        return parent::setOrderers($orderers);
    }
    ...
    public function getOrderers()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrderers', array());

        return parent::getOrderers();
    }
