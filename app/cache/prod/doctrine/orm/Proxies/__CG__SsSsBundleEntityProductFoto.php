 ...
 */
class ProductFoto extends \Ss\SsBundle\Entity\ProductFoto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ss\\SsBundle\\Entity\\ProductFoto' . "\0" . 'id', '' . "\0" . 'Ss\\SsBundle\\Entity\\ProductFoto' . "\0" . 'name', '' . "\0" . 'Ss\\SsBundle\\Entity\\ProductFoto' . "\0" . 'token', '' . "\0" . 'Ss\\SsBundle\\Entity\\ProductFoto' . "\0" . 'created_at', '' . "\0" . 'Ss\\SsBundle\\Entity\\ProductFoto' . "\0" . 'updated_at', '' . "\0" . 'Ss\\SsBundle\\Entity\\ProductFoto' . "\0" . 'products');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductFoto $proxy) {
